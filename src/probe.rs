...
impl BlkidProbe {
    ...
    pub fn enable_superblocks(&mut self, enable: bool) -> Result<()> {
        errno!(unsafe {
            libblkid_rs_sys::blkid_probe_enable_superblocks(self.0, i32::from(enable))
        })
    }
    ...
    pub fn enable_topology(&mut self, enable: bool) -> Result<()> {
        errno!(unsafe { libblkid_rs_sys::blkid_probe_enable_topology(self.0, i32::from(enable)) })
    }
    ...
    pub fn enable_partitions(&mut self, enable: bool) -> Result<()> {
        errno!(unsafe { libblkid_rs_sys::blkid_probe_enable_partitions(self.0, i32::from(enable)) })
    }
    ...
    pub fn do_wipe(&mut self, dry_run: bool) -> Result<()> {
        errno!(unsafe { libblkid_rs_sys::blkid_do_wipe(self.0, i32::from(dry_run)) })
    }
